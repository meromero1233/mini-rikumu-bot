...
// ─── 新メンバー参加時、雑談で歓迎する ─────────────────────────────────────────
// 呼び方も聞いて、本人が答えたらそれがデフォルトの呼び方になる
const WELCOMES = [
  (m) => `${m} きたっ！🐾✨ ようこそ〜！ぼくみにりくだよ。なんて呼んだらいい？💕`,
  (m) => `わっ、新しい子だ！${m} いらっしゃい🥹 ぼくのことは何て呼んでもいいよ〜！きみのことは何て呼べばいい？`,
  (m) => `${m} ようこそっ🙌 これから仲良くしてね！あ、なんて呼んだらいいか教えて〜✨`,
  (m) => `やっほー ${m} ！🥳 新しい仲間だ〜！きみのこと、なんて呼ぼっかな？希望あったら言ってね💕`,
  (m) => `${m} いらっしゃい〜🎉 ぼくみにりく！困ったら @ で話しかけてね。ところで、なんて呼んだらいい？😊`,
];

// にゃんちゅうのときは、他の人よりちょっとだけ嬉しそうにする（やりすぎない）
const NYANCHU_ID = '965607187936337960';
const NYANCHU_WELCOMES = [
  (m) => `あ、${m} だ！🥹✨ 来てくれて嬉しい〜！ようこそっ💕`,
  (m) => `${m} いらっしゃい！🐾 ちょっとテンション上がっちゃう、ようこそ〜✨`,
  (m) => `わっ ${m} きた！🥹 会えて嬉しいよ〜！ゆっくりしてってね💕`,
];
